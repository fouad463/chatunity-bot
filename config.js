...
global.owner = [
  ['212753780787', '𝐂𝐡𝐚𝐭𝐔𝐧𝐢𝐭𝐲', true], // VIETATO ELIMINARE IL CREATORE (se lo fai te ne pentirai)
  ['212753780787', 'Kinderino', true],
  ['212753780787', 'matte', true], // al posto del X metti il tuo numero di telefono
  ['xxxxxxxxxx'],	
  ['xxxxxxxxxx'],
  ['xxxxxxxxxx'],
  ['xxxxxxxxxx'],
